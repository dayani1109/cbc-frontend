    ...
    <div className="w-full min-h-[calc(100vh-100px)] bg-primary flex flex-col pt-[30px] items-center">
      <div className="w-full max-w-[650px] flex flex-col gap-5 px-4">
        ...
        {cart.map((item, index) => {
          return (
            ...
            >
                ...
                }><FaRegTrashCan size={18} /></button>

                <img className="h-full aspect-square object-cover rounded-lg shadow-sm" src={item.image}/>

                <div className="w-[200px] h-full flex flex-col pl-[10px] pt-[10px]">
                    <h1 className="font-semibold text-lg w-full text-wrap text-secondary leading-tight">{item.name}</h1>
                    {/*productID */}
                ...
                <div className="w-[90px] h-full flex flex-col justify-center items-center">
                    ...
                    <FaCaretDown 
                      ...
                      onClick={()=>{
                            ...
                            if(newCart[index].quantity >1){//1ta wada wedinm witrayi
                ...
                <div className="w-[150px]  h-full flex flex-col items-end">
                    {
                        ...
                        <span className="text-secondary w-full text-right pr-[10px] line-through 
                        text-lg opacity-60 mt-[20px]">LKR {item.labelledPrice.toFixed(2)}</span>
                    }
                    <span className="text-accent font-bold w-full text-right pr-[10px]  
                    text-2xl mt-[5px]">LKR {item.price.toFixed(2)}</span>
        ...
        <div className="w-full h-[130px] bg-white rounded-xl shadow-md flex justify-between items-center px-6">
            <button className="bg-accent text-white px-6 py-3 rounded-lg shadow hover:bg-accent/90 
            transition font-semibold hover:scale-[1.02] active:scale-95">Order</button>
