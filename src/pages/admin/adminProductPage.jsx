    ...
    <div className="w-full h-full p-6 bg-primary">
        <div className="flex justify-between items-center mb-6">
            <h1 className="text-3xl font-bold text-accent">Product Management</h1>
                <Link to="/admin/add-product" className="flex items-center gap-2 bg-accent text-white font-semibold px-5 py-2 rounded-lg shadow-md hover:bg-boardercolor transition-colors">
              ...
              >
                ...
                <td className="py-3 px-4">
                  <div className="flex flex-row gap-4 justify-center items-center">
                    <FaRegEdit className="cursor-pointer hover:text-accent hover:scale-110 transition-transform" />
                    <IoTrashOutline className="cursor-pointer hover:text-red-500 hover:scale-110 transition-transform" />
                  </div>
                </td>
              </tr>
            ))}
