  ...
  return (
    <div className="w-[300px] h-[420px] bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300 flex flex-col overflow-hidden m-3">
      ...
      <div className="flex flex-col justify-between flex-grow px-4 py-3">
        ...
        {/* Action Button */}
        <Link to = {"/overview/"+product.productID} className="w-full mt-3 py-2 rounded-xl border text-center border-boardercolor text-accent font-semibold hover:bg-accent hover:text-white transition-all duration-300">
          View Product
        </Link>
      </div>
    </div>
