...
export default function UserSettings() {
	...
	async function updatePassword() {
        if (password !== confirmPassword) {//password match nathnm
        ...
        await axios.put(import.meta.env.VITE_API_URL + "/api/users/me/password", {
            ...
            setPassword("");//aluth password ek yavala update karagann kiyanava
            setConfirmPassword("");
        }).catch((err)=>{
	...
	return (
		<div className="w-full h-full bg-[url('/cosmatic.jpg')] bg-cover bg-center bg-no-repeat flex flex-col lg:flex-row justify-center">
			{/* Left: User Info */}
