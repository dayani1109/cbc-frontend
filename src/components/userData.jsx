      ...
      {user && (
        ...
        >
          ...
          <div className="relative group">
            <button className="p-1 rounded-md hover:bg-accent/20 transition">
            ...
            >
              ...
              <button
                className="text-left px-4 py-2 hover:bg-primary/70 transition w-full"
        ...
        <div className="fixed z-[120] w-full h-screen top-0 left-0 bg-black/40 flex items-center justify-center">
          <div className="w-[350px] bg-primary rounded-xl shadow-xl border border-boardercolor p-6 flex flex-col gap-6">
            ...
            <div className="flex justify-between gap-4">
              <button
                className="flex-1 bg-accent text-white font-medium py-2 rounded-lg shadow hover:bg-accent/15 hover:text-accent transition-colors"
                onClick={() => {
                  localStorage.removeItem("token");
            ...
            <button
              className="w-full bg-accent text-white font-medium py-2 rounded-lg shadow hover:bg-accent/15 hover:text-accent transition-colors"
              onClick={() => setIsLogoutConfirmOpen(false)}
            >
              Cancel
            </button>
